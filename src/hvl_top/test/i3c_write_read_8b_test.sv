class i3c_write_read_8b_test extends i3c_base_test;
  `uvm_component_utils(i3c_write_read_8b_test)

  i3c_sdr_write_read_virtual_seq  sdrWriteReadSeq;
 
  function new(string name="i3c_write_read_8b_test.s", uvm_component parent=null);
